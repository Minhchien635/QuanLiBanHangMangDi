...
/*	    @FXML
	    void action_xoa(ActionEvent event) {
	    	try {
	    		...
	    		alert1.setTitle("Thông báo");
	    		alert1.setHeaderText(null);
	    		alert1.setContentText("Chọn nguyên liệu cần xóa");
	    		alert1.showAndWait();
			}
	    }
*/	    
	    private void loadNguyenLieu() {
			ObservableList<NguyenLieu> listNguyenLieu = FXCollections.observableArrayList(DAO.getTenNguyenLieu());
