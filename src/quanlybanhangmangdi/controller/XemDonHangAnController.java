...
public class XemDonHangAnController implements Initializable {
	...
	public static ObservableList<DonHangTable> listDonHang = FXCollections
			.observableArrayList(DAO.getDuLieuDonHangAnTable());
